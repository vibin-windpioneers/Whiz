        ...
        rx.desktop_only(
            rx.hstack(
                rx.hstack(
                    ...
                    rx.link(
                        rx.heading("Wind Whiz", size="7", weight="bold"),
                        href=navigation.routes.HOME_ROUTE,
                    ),
                    align_items="center",
                ),
        ...
        rx.mobile_and_tablet(
            rx.hstack(
                rx.hstack(
                    ...
                    rx.heading("Wind Whiz", size="6", weight="bold"),
                    align_items="center",
                ),
                rx.menu.root(
                    ...
                    rx.menu.content(
                        ...
                        rx.menu.item(
                            "Contact", on_click=navigation.NavState.to_contact_us
                        ),
                        rx.menu.separator(),
                        rx.menu.item("Log in", on_click=navigation.NavState.to_login),
                        rx.menu.item("Sign up", on_click=navigation.NavState.to_signup),
                    ),
                    justify="end",
                ),
                justify="between",
                align_items="center",
                id="navbar-hstack-mobileandtablet",
            ),
        ),
